...
#                 '#\n'
#                 'deb [arch=armel,amd64 lang=en_US] http://example.com ubuntu main ## X-Repolib-Name: example-com\n'
#                 'deb-src [arch=armel,amd64 lang=en_US] http://example.com ubuntu main ## X-Repolib-Name: example-com\n'
#             )
...
#                 '## Added/managed by repolib ##\n'
#                 '#\n'
#                 'deb [trusted=yes] file:///var/cache/apt/archives ./ ## X-Repolib-Name: test no suites\n'
#                 'deb-src [trusted=yes] file:///var/cache/apt/archives ./ ## X-Repolib-Name: test no suites\n'
#             )
...
#                 '\n'
#                 '\n'
#                 'deb [trusted=yes] file:///var/cache/apt/archives ./ ## X-Repolib-Name: long comments\n'
#                 'deb-src [trusted=yes] file:///var/cache/apt/archives ./ ## X-Repolib-Name: long comments\n'
#             )
...
#         expected = '## Added/managed by repolib ##\n#\ndeb [arch=amd64] https://example.com ubuntu main universe ## X-Repolib-Name: example-com\ndeb-src [arch=amd64] https://example.com ubuntu main universe ## X-Repolib-Name: example-com\n'
